...
@Validated
public interface MediaIdadePorTipoSanguineoApi {

    @Operation(summary = "retorna a média de idade para cada tipo sanguineo", description = "retorna a média de idade para cada tipo sanguineo ", tags={ "mediaIdadePorTipoSanguineo" })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/mediaIdadePorTipoSanguineo",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Response> getMediaIdadePorTipoSanguineo();
