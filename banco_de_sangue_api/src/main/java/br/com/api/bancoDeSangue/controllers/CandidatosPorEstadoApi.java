...
@Validated
public interface CandidatosPorEstadoApi {

    @Operation(summary = "retorna a quantidade de candidatos para cada estado da federação", description = "retorna a quantidade de candidatos para cada estado da federação ", tags={ "candidatosPorEstado" })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/candidatosPorEstado",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Response> getCandidatosPorEstado();
